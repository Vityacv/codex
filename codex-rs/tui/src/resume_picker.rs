...
mod tests {
    ...
    fn column_visibility_hides_extra_date_column_when_narrow() {
        ...
        let created =
            column_visibility(30, &metrics, ThreadSortKey::CreatedAt, SortMode::BackendOrder);
        assert_eq!(
            created,
            ColumnVisibility {
                show_created: true,
        ...
        let updated =
            column_visibility(30, &metrics, ThreadSortKey::UpdatedAt, SortMode::BackendOrder);
        assert_eq!(
            updated,
            ColumnVisibility {
                show_created: false,
        ...
        let wide =
            column_visibility(40, &metrics, ThreadSortKey::CreatedAt, SortMode::BackendOrder);
        assert_eq!(
            wide,
            ColumnVisibility {
                show_created: true,
